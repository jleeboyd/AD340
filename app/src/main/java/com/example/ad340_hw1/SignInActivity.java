...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("108334260275-dd2m6e9qmc8npfdck4lokpc8gp442atf.apps.googleusercontent.com") // Oauth google console-> api/services -> credentials -> web app
                .requestEmail()
                .build();
    ...
    private void firebaseAuthWithGoogle(String idToken) {
        ...
        mFirebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, task -> {
            ...
            if (!task.isSuccessful()) {
                ...
                // If authenticated go to tab activity with dummy bundle in matches & settings
